                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                @forelse($accepted as $accept )
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a type="button" href="{{route("admin.delete.request",$accept->id)}}" class="btn btn-danger">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="return" tabindex="-1" role="dialog" aria-labelledby="returnll" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="returnll">Return request</h5>
                                                    <button type="button" class="btn btn-default" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a type="button" href="{{route("admin.return.request",[$accept->id,$accept->amount])}}"
                                                       class="btn btn-soft-danger">Return</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @empty
                                    <p>There is no accepted requests until now !!</p>
                                @endforelse
                                    </tbody>
                                </table>
                            </div>
