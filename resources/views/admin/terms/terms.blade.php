                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item active">FoodTruck Terms and Conditions</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="header-title">Terms and Conditions</h5>
                                ...
                                <div>
                                    ...
                                    <p>
                                        @else
                                            Add Terms and conditions to show.
                                        @endif
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <form method="post" action="{{route("admin.post.terms")}}">
                                @csrf
                                <h4 class="card-title">Update Terms and Conditions Content</h4>
                                <div class="mb-3">
                                    <div>
